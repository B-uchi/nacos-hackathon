    ...
    <section id='hero-section'>
        <div className="hero-left">
            ...
            <div className="hero-left-middle">
                <HeroArticle hero={true} tag={'TECHNOLOGY'} title={'NACOS virtual hackathon'} duration={'5 min read'} date={'27th June 2023'} pic={pic1} id={matches && true}/>
                <HeroArticle hero={true} tag={'VEHICLES'} title={'Volvo releases killer SUV'} duration={'3 min read'} date={'20th May 2023'} pic={pic2} id={matches && true}/>
            </div>
            <div className="hero-left-bottom">
                <HeroArticle hero={true} tag={'SPACE'} title={'Zoom off into the nexus'} duration={'10 min read'} date={'21th June 2023'} pic={pic3} id={true}/>
            </div>
        </div>
